...
public class ActionItemBadge {
  ...
  public static void update(final Activity act, final MenuItem menuItem, Drawable icon, BadgeStyle badgeStyle, Boolean shouldShowBadge) {
    ...
    badge.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        act.onOptionsItemSelected(menuItem);
      }
    });
